...
import { Typography, Box, IconButton, Menu, TextField, InputAdornment, FormControlLabel, Checkbox, Button, useMediaQuery } from "@mui/material";
import {
        ...
        <Box sx={{ display: "flex", flexDirection: "column", boxShadow: 2, p: 2 }}>
            ...
            >
                <Box sx={{ p: 2 }}>
                    ...
                    <FormControlLabel
                        control={<Checkbox checked={isReadFilter === false} onChange={() => setIsReadFilter(false)} />}
                        label="Unread"
                    />
